...
namespace Excel2Binary
{
    class LiAsExcelDB
    {
        /// <summary>
        /*---------------------------------------------------------------------
         * HDR = 첫줄을 헤더로 사용할 것인지( YES/NO )
         * IMEX = 데이터유형적용여부( IMEX=1 -> String IMEX = 0 or 2 -> 셀의 데이터대로
         *-------------------------------------------------------------------*/
        ...
        /// </param>
        public static DataSet OpenExcelDB(string ExcelFile, bool UseHeader)
        {
            return OpenExcel(ExcelFile, UseHeader);
        }
