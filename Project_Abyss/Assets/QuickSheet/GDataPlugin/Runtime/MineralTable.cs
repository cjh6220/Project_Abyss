...
/// 
[System.Serializable]
public class MineralTable : ScriptableObject 
{
    ...
    public MineralTableData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new MineralTableData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public MineralTableData FindByKey(string key)
    //{
