...
/// 
[System.Serializable]
public class ParticleTable : ScriptableObject 
{
    ...
    public ParticleTableData[] dataArray;
...
//#endif
        ...
        // 
        if (dataArray == null)
            dataArray = new ParticleTableData[0];
    }
    
    //
    // Write a proper query methods for retrieving data.
    //
    //public ParticleTableData FindByKey(string key)
    //{
